...
export default function CommonShowcase() {
  return (
    <section id="common" className="mb-16 scroll-mt-20">
      {/* 섹션 제목 */}
      <h2 className="mb-6 text-2xl font-bold text-foreground">공통 컴포넌트</h2>
      ...
      <div className="space-y-8">
        ...
        <div className="rounded-lg border p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-4">
              <span className="w-20 text-xs text-muted-foreground">최고점</span>
            ...
            <div className="flex items-center gap-4">
              <span className="w-20 text-xs text-muted-foreground">보통</span>
        ...
        <div className="rounded-lg border p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-4">
              <span className="w-24 text-xs text-muted-foreground">2일 후</span>
